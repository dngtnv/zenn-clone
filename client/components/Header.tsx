					...
					<div>
						<div className='flex items-center'>
							...
							<div className='flex items-center content-center ml-4'>
								...
								<div>
									<button className='hidden tablet:inline-flex w-[92px] h-9 items-center justify-center text-white font-semibold text-sm bg-blue-lighter rounded-[7px] ml-[22px] hover:bg-blue-darker transition duration-[250ms] ease-out'>
										Add new
									</button>
								</div>
							</div>
