  ...
  return (
    <>
      ...
      <main>
        <section className="bg-main-blue py-14">
          <div className="mx-auto max-w-[960px] px-[14px] mobile:px-5 tablet:px-[25px] laptop:px-10">
            <div className="flex items-center">
              ...
              >
                <span className="flex h-[17px] w-[17px] translate-y-[5px] justify-center rounded-[50%] bg-gray-lighter text-[10px] leading-[17px] text-white group-hover:bg-gray-primary">
                  ?
                </span>
              </Tooltip>
            </div>
        ...
        <section className="mt-[2px] bg-main-gray px-0 pb-16 pt-14">
          <div className="mx-auto max-w-[960px] px-[14px] mobile:px-5 tablet:px-[25px] laptop:px-10">
            <div className="flex items-center">
              <h1 className="mr-[6px] text-2xl font-bold leading-[1.3] text-primary">
                Ideas
        ...
        <section className="bg-white px-0 pb-16 pt-14">
          <div className="mx-auto max-w-[960px] px-[14px] mobile:px-5 tablet:px-[25px] laptop:px-10">
            <div className="flex items-center">
        ...
        <section className="mt-4 bg-main-gray px-0 py-[3.8rem]">
          <div className="mx-auto max-w-[960px] px-[14px] mobile:px-5 tablet:px-[25px] laptop:px-10">
            <div className="flex items-center">
              <h1 className="text-2xl font-bold leading-[1.3] text-primary">
                Featured
